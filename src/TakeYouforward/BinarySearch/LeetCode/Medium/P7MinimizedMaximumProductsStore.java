...
public class P7MinimizedMaximumProductsStore {
...
//        int n = 7;
    ...
    public static boolean canDistribute(int n, int[] quantities, int mid) {
        int storeCount = 0;
        for (int quantity : quantities) {
            storeCount += Math.ceil((double) quantity / (double) mid);
